...
struct Piece {
    ...
    mutating func populatePiece(type: Int) {
        ...
        case Constants.TwoByTwo:
            // 2x2
            let rowOne: [UIColor?] = [Constants.LightGreenColor, Constants.LightGreenColor, nil, nil]
            rows[0] = rowOne
            rows[1] = rowOne
            return
        ...
        case Constants.OneByFour:
            // 1x4
            let rowOne: [UIColor?] = [Constants.PurpleColor, nil, nil, nil]
            rows[0] = rowOne
            rows[1] = rowOne
            rows[2] = rowOne
            rows[3] = rowOne
        ...
        case Constants.FourByOne:
            // 4 x 1
            let rowOne: [UIColor?] = [Constants.PurpleColor, Constants.PurpleColor, Constants.PurpleColor, Constants.PurpleColor]
            rows[0] = rowOne
            return
            
        case Constants.TwoByFourEll:
            let rowOne: [UIColor?] = [Constants.DarkBlueColor, nil, nil, nil]
            let rowTwo: [UIColor?] = [Constants.DarkBlueColor, Constants.DarkBlueColor, nil, nil]
            rows[0] = rowOne
            rows[1] = rowOne
            rows[2] = rowOne
            rows[3] = rowTwo
        ...
        case Constants.TwoByTwoEll:
            let row0: [UIColor?] = [Constants.WhiteColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.WhiteColor, Constants.WhiteColor, nil, nil]
        ...
        case Constants.OneByThreeEll:
            let row0: [UIColor?] = [Constants.OrangeColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.OrangeColor, Constants.OrangeColor, nil, nil]
            let row2: [UIColor?] = [nil, nil, nil, nil]
            rows[0] = row0
            rows[1] = row0
            rows[2] = row1
        ...
        case Constants.ThreeByThreeEll:
            let row0: [UIColor?] = [Constants.LightBlueColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.LightBlueColor, Constants.LightBlueColor, Constants.LightBlueColor, nil]
            let row2: [UIColor?] = [nil, nil, nil, nil]
            rows[0] = row0
            rows[1] = row0
            rows[2] = row1
        ...
        case Constants.TwoByThreeCee:
            let row0: [UIColor?] = [Constants.YellowColor, Constants.YellowColor, nil, nil]
            let row1: [UIColor?] = [Constants.YellowColor, nil, nil, nil]
            let row2: [UIColor?] = [nil, nil, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row0
        ...
        case Constants.TwoByThreeBee:
            let row0: [UIColor?] = [Constants.RedColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.RedColor, Constants.RedColor, nil, nil]
            let row2: [UIColor?] = [nil, nil, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row1
        ...
        case Constants.ThreeByThreeCross:
            let row0: [UIColor?] = [nil, Constants.GreyColor, nil, nil]
            let row1: [UIColor?] = [Constants.GreyColor, Constants.GreyColor, Constants.GreyColor, nil]
            let row2: [UIColor?] = [nil, nil, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row0
        ...
        case Constants.TwoByFourTee:
            let row0: [UIColor?] = [Constants.LightPinkColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.LightPinkColor, Constants.LightPinkColor, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row0
            rows[3] = row0
        ...
        case Constants.TwoByFourWhy:
            let row0: [UIColor?] = [Constants.DarkGreenColor, nil, nil, nil]
            let row1: [UIColor?] = [Constants.DarkGreenColor, Constants.DarkGreenColor, nil, nil]
            let row2: [UIColor?] = [nil, Constants.DarkGreenColor, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row2
            rows[3] = row2
        ...
        case Constants.ThreeByThreeEmm:
            let row0: [UIColor?] = [nil, Constants.DarkPinkColor, Constants.DarkPinkColor, nil]
            let row1: [UIColor?] = [Constants.DarkPinkColor, Constants.DarkPinkColor, nil, nil]
            let row2: [UIColor?] = [Constants.DarkPinkColor, nil, nil, nil]
            rows[0] = row0
            rows[1] = row1
            rows[2] = row2
            return
